...
import NavbarMenu from "@/app/(web)/_components/navbar-menu";
...
const HeroSection = () => {
  return (
    <>
      ...
      />
      <section className="relative overflow-hidden pb-8 md:min-h-screen dark:bg-black/50">
        ...
        <Image
          ...
          priority
        />
        <LightRays className="-z-10 h-full w-full overflow-hidden" count={12} />
        <FlickeringGrid
        ...
        />
        {/* Desktop */}
        <div className="hidden px-24 py-20 md:block">
          <WordByWordEffect>
          ...
          <div className={cn("flex items-start justify-between pt-20")}>
            ...
            >
              ...
              <p className="text-muted-foreground leading-7">
                ...
                building reliable, scalable and high-performance applications
                with Go, React and React Native. I turn ideas into fast,
                production-ready digital experiences designed for real-world
                impact.
              </p>

              <div className="flex max-w-150 items-center gap-8">
                <Button className="flex-1 rounded-4xl px-12 py-8 text-lg font-medium">
                  View Projects
                </Button>
                <Button
                  className="flex-1 rounded-4xl border-black px-12 py-8 text-lg font-medium"
                  variant="outline"
                >
                  <FaWhatsapp className="h-[1.2rem] w-[1.2rem] scale-100" />
                  WhatsApp Me
                </Button>
              </div>
            </motion.div>
          ...
          <div className="pt-10">
            ...
            >
              ...
              <div className="flex items-center gap-8">
                <Button className="flex-1 rounded-4xl px-4 py-6 font-medium">
                  View Projects
                </Button>
                <Button
                  className="flex-1 rounded-4xl border-black px-4 py-6 font-medium"
                  variant="outline"
                >
                  <FaWhatsapp className="h-[1.2rem] w-[1.2rem] scale-100" />
        ...
        <div className="absolute top-1/4 right-4 hidden w-fit space-y-4 md:block">
          <div
            className={cn(
              "floating-element rounded-lg border border-red-500/50 p-3 font-mono text-xs text-purple-600 dark:text-purple-300",
              "bg-linear-to-r from-white to-gray-100",
              "dark:bg-transparent dark:bg-none",
            )}
          >
            <span className="text-pink-600 dark:text-pink-300">const</span>{" "}
            skills = [<br></br>
            &nbsp;&nbsp;
        ...
        <div className="absolute top-1/2 right-4 hidden w-fit space-y-4 md:block">
          ...
          >
            <span className="text-yellow-600 dark:text-yellow-300">func</span>{" "}
            <span className="text-blue-600 dark:text-blue-300">main</span>()
            &#123;
            <br />
            &nbsp;&nbsp;fmt.Println(
            <span className="text-green-600 dark:text-green-300">
